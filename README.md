...
## Build a new application using the Content Item Example Rails application template:
Since the project is not public you will need to have a local copy of the content_item_example project.
Be sure to use the correct relative path:

`rails new my_app -m ./content_item_example/template.rb`


## Running Content Item Example
-----------
...
## Setting up Content Item Example
-----------
...
the project:
DROPBOX_FOLDER=aj-dev/content_item_example
...
1. Open application.rb and change `ContentItemExample` to the name you choose.
2. Do a global search and replace for `content_item_example` and change it to the name you choose.
3. Do a global search and replace for `ContentItemExample` (use only letters or numbers for this name. Special characters like '_' will result in errors).
...
browsers. The Content Item Example uses React. During development run the [React Hot Loader](https://github.com/gaearon/react-hot-loader).
...
production URI will use your domain (e.g. ContentItemExample.herokuapp.com).

**Oauth2 Redirect URI:**
https://lti.atomicjolt.xyz/auth/[provider]/callback
**Key Name:**
Can be anything you choose (e.g. Content Item Example)

**Owner Email:***
Address that will receive email about technical issues related to the tool.

**Tool ID:**
Unique ID for the tool (e.g. ContentItemExample)

**Redirect URI:**
https://lti.atomicjolt.xyz/users/auth/canvas/callback
OR
https://ContentItemExample.herokuapp.com/users/auth/canvas/callback

**Icon URL:**
https://lti.atomicjolt.xyz/images/icon.png
OR
https://ContentItemExample.herokuapp.com/images/icon.png
